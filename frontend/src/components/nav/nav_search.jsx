    ...
    render(){
        ...
        return(
            // <div className='search-container'>
                ...
                //         <button onClick={() => this.handleSubmit}><i class="material-icons">search</i></button>
                //     </div>
            ...
            <form className='search-form' onSubmit={this.handleSubmit}>
                ...
                <div className='search-input-div'>
                    ...
                    <div>
                    <button id='search-button' onClick={() => this.handleSubmit}><i class="material-icons">search</i></button>
                    </div>
                </div>
